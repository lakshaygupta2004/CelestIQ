            ...
            <div className="main-container">
                ...
                {!showResult
                    ...
                    <div className='result' ref={resultRef}>
                        ...
                        <div className="result-data">
                            <img className="result-data-icon" src={assets.celest_iq_icon} alt=""/>
                            {loading ?
                ...
                <div className="main-bottom">
                    ...
                    <p className="bottom-info">
                        CelestIQ may display inaccurate info, including about people, so double-check its responses.   
                        <a href="#">  Your privacy and CelestIQ</a>
                    </p>
                </div>
            </div>
        </main>
